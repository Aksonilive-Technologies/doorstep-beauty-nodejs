const { calculatePartnerCommission } = require("../helper/calculatePartnerCommission");
const Booking = require("../models/bookingModel");
const Customer = require("../models/customerModel");
const FirebaseToken = require("../models/firebaseTokenModel");
...
exports.assignPartnerToBooking = async (req, res) => {
  ...
  try {
    ...
    const customerTokens = await FirebaseToken.find({ userId: booking.customer, userType: "customer" });
    if (customerTokens) {
